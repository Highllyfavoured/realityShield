    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900">
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-400 max-w-2xl mx-auto">
            Real-time multimodal detection ecosystem designed to identify and neutralize synthetic deception using state-of-the-art neural forensics.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <DetectionModule
            type="media"
            title="Media Forensic"
            subtitle="Neural Image Analysis"
            description="Utilizes SigLIP-2 (Sigma-Sigmoid) architecture to detect latent space artifacts and PRNU sensor noise in high-fidelity AI diffusion models."
            icon={ImageIcon}
          ...
          <DetectionModule
            type="audio"
            title="Audio Forensic"
            subtitle="Spectral Discontinuity Check"
            description="Analyzes vocal biometrics via RawNet3 to detect sub-perceptual frequency-domain traces found in real-time voice cloning and synthetic audio."
            icon={Mic}
            model="mothecreator/deepfake-audio-detection"
            setResult={setCurrentResult}
            isAnalyzing={isAnalyzing}
            setIsAnalyzing={setIsAnalyzing}
            iconColor="text-orange-400"
          ...
          <DetectionModule
            type="text"
            title="Fake News Detector"
            subtitle="Stylometric Linguistic Check"
            description="DeBERTa-v3 based analysis for identifying hyper-partisan emotional loading and machine-generated linguistic fingerprinting in news content."
            icon={FileText}
            model="dhruvpal/fake-news-bert"
            setResult={setCurrentResult}
            isAnalyzing={isAnalyzing}
      ...
      <footer className="border-t border-blue-500/20 bg-slate-950/50 py-8 mt-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-slate-500 text-xs mt-2">
            Multi-modal Trust Infrastructure Layer
          </p>
        </div>
      </footer>
    </div>
